...
public class IT24104016Lab3Q3 { 
    public static void main(String[] args) { 
        Scanner scanner = new Scanner(System.in); 
        
        System.out.print("Enter the amount: ");         int amount = scanner.nextInt(); 
        
        int notes5000 = amount / 5000;         amount %= 5000; 
        
        int notes1000 = amount / 1000;         amount %= 1000; 
        
        int notes500 = amount / 500;         amount %= 500; 
        
        int notes200 = amount / 200;         amount %= 200; 
        ...
        int coins5 = amount / 5;         amount %= 5; 
        
        int coins2 = amount / 2;         amount %= 2; 
        ...
        System.out.println("2 Coins - " + coins2);         System.out.println("1 Coins - " + coins1);         scanner.close(); 
    } 
} 
